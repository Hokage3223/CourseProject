...
{
    public partial class remixGKMC : Form
    {
        ...
        {
            RemixPanel.Controls.Clear();

            form.TopLevel = false;
            form.Dock = DockStyle.Fill;

            RemixPanel.Controls.Add(form);
        ...
        {
            wmp.URL = @"C:\Users\david\source\repos\CourseProject\Coursa4\songs\Remix.mp3";
            wmp.controls.play();
            isPaused = false;
            timer.Start();
        ...
        {
            Process.Start("https://youtu.be/qdr-ne7UNTo?si=_If8W5Ns-A40wJuL");
        }
    }
}
