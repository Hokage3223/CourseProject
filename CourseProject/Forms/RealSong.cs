...
{
    public partial class RealSong : Form
    {
        ...
        {
            wmp.URL = @"C:\Users\david\source\repos\CourseProject\Coursa4\songs\Real.mp3";
            wmp.controls.play();
            isPaused = false;
            timer.Start();
        ...
        private void RealPanel_Paint(object sender, PaintEventArgs e)
        {
