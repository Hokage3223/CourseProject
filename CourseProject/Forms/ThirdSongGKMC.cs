...
{
    public partial class ThirdSongGKMC : Form
    {
        ...
        {
            thirdSongPanel.Controls.Clear();

            form.TopLevel = false;
            form.Dock = DockStyle.Fill;

            thirdSongPanel.Controls.Add(form);
        ...
        {
            wmp.URL = @"C:\Users\david\source\repos\CourseProject\Coursa4\songs\Backseat.mp3";
            wmp.controls.play();
            isPaused = false;
            timer.Start();
        ...
        {
            loadpage(new TheArtOfPeerPressure());
            if (!isPaused)
            {
                wmp.controls.pause();
                pausePosition = wmp.controls.currentPosition;
        ...
        {
            Process.Start("https://www.youtube.com/watch?v=EZW7et3tPuQ");
        }
    }
}
