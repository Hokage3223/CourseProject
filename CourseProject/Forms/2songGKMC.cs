...
{
    public partial class SecondsongGKMC : Form
    {
        ...
        {
            SecindSongpanel.Controls.Clear();

            form.TopLevel = false;
            form.Dock = DockStyle.Fill;

            SecindSongpanel.Controls.Add(form);
        ...
        {
            wmp.URL = @"C:\Users\david\source\repos\CourseProject\Coursa4\songs\Bitch.mp3";
            wmp.controls.play();
            isPaused = false;
            timer.Start();
        ...
        {
            Process.Start("https://www.youtube.com/watch?v=GF8aaTu2kg0");
        }
    }
}
