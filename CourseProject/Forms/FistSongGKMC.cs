...
{
    public partial class FistSongGKMC : Form
    {
        ...
        {
            wmp.URL = @"C:\Users\david\source\repos\CourseProject\Coursa4\songs\Sherane.mp3";
            wmp.controls.play();
            isPaused = false;
            timer.Start();
        ...
        {
            FirstSongPanel.Controls.Clear();

            form.TopLevel = false;
            form.Dock = DockStyle.Fill;
            
            FirstSongPanel.Controls.Add(form);
            form.Show();
        }
