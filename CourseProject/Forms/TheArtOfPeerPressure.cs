...
{
    public partial class TheArtOfPeerPressure : Form
    {
        ...
        {
            TheArtPanel.Controls.Clear();

            form.TopLevel = false;
            form.Dock = DockStyle.Fill;

            TheArtPanel.Controls.Add(form);
        ...
        {
            wmp.URL = @"C:\Users\david\source\repos\CourseProject\Coursa4\songs\The Art.mp3";
            wmp.controls.play();
            isPaused = false;
            timer.Start();
