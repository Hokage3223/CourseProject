...
{
    public partial class sixthSongGKMC : Form
    {
        ...
        {
            sixthSongPanel.Controls.Clear();

            form.TopLevel = false;
            form.Dock = DockStyle.Fill;

            sixthSongPanel.Controls.Add(form);
        ...
        {
            wmp.URL = @"C:\Users\david\source\repos\CourseProject\Coursa4\songs\good.mp3";
            wmp.controls.play();
            isPaused = false;
            timer.Start();
