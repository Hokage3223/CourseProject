...
{
    public partial class ComptonSong : Form
    {
        ...
        {
            ComptonPanel.Controls.Clear();

            form.TopLevel = false;
            form.Dock = DockStyle.Fill;

            ComptonPanel.Controls.Add(form);
        ...
        {
            wmp.URL = @"C:\Users\david\source\repos\CourseProject\Coursa4\songs\Compton.mp3";
            wmp.controls.play();
            isPaused = false;
            timer.Start();
