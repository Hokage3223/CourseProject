...
{
    public partial class EightSongGKMCcs : Form
    {
        ...
        {
            eightpanel.Controls.Clear();

            form.TopLevel = false;
            form.Dock = DockStyle.Fill;

            eightpanel.Controls.Add(form);
        ...
        {
            wmp.URL = @"C:\Users\david\source\repos\CourseProject\Coursa4\songs\Swimming.mp3";
            wmp.controls.play();
            isPaused = false;
            timer.Start();
        ...
        {
            Process.Start("https://www.youtube.com/watch?v=B5YNiCfWC3A");
        }
    }
}
