...
{
    public partial class SeventhSongGKMC : Form
    {
        ...
        {
            seventhPanel.Controls.Clear();

            form.TopLevel = false;
            form.Dock = DockStyle.Fill;

            seventhPanel.Controls.Add(form);
        ...
        {
            wmp.URL = @"C:\Users\david\source\repos\CourseProject\Coursa4\songs\m.A.A.d.mp3";
            wmp.controls.play();
            isPaused = false;
            timer.Start();
